...
struct ContainerTest {
	...
	~ContainerTest() {
		...
		out_strm << 	"front_insertion, front_access, front_search, front_remove, back_insertion, back_access, back_search, back_remove, middle_insertion, middle_access, middle_search, middle_remove, size_query, clear" << endl;
